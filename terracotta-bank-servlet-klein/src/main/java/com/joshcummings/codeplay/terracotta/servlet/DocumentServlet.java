...
/**
 * This is a sample servlet with many different vulnerabilities
 * demonstrated. Can you find them all? Check out the first module
 * of "Securing Java Web Applications" on Pluralsight to see if you
 * caught them all.
 *
