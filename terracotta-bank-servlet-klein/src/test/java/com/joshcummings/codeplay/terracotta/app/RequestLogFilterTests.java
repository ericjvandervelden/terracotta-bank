...
//		assertEquals("1", attributes.get("userId"));
		assertThat("1").isEqualTo(attributes.get("userId"));
	}
...
//		assertEquals(1000L, attributes.get("duration"));
		assertThat(attributes.get("requestId")).isNotNull();
		assertThat(attributes.get("sessionId")).isNotNull();
		assertThat(attributes.get("userId")).isNull();
		assertThat(request.getRequestURI()).isEqualTo(attributes.get("action"));
		assertThat(response.getStatus()).isEqualTo(attributes.get("result"));
		assertThat(1000L).isEqualTo(attributes.get("duration"));
